...
function Meetus() {
  return (
    <div className='bg-indigo-950 flex items-center  justify-around px-8 py-30 relative pb-30 mt-20' >
      <div className='text-white w-[35%] snap-center '>
      ...
      <div className='w-[50%] ' >
        <Image src="/assets/emergency_img.jpg" alt='image' width={600} height={700} className='rounded-md text-shadow-lg absolute bottom-3/12 ' />
      </div>
    </div>
  )
}
